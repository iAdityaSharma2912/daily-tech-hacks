...
repo_path = os.getcwd()  # This will work if you run the GitHub Action directly in the repo

# List of tech hacks (you can expand this list or load it from a file)
tech_hacks = [
...
# Get a random hack from the list
daily_hack = random.choice(tech_hacks)
...
# Open README.md and append the daily tech hack
with open(readme_file, 'a') as f:
    f.write(f"\n## Hack for {time.ctime()}\n")
    f.write(f"{daily_hack}\n")

# Stage the README file for commit
repo.git.add(readme_file)

# Commit the changes
commit_message = f"Daily Tech Hack Update: {time.ctime()}"
